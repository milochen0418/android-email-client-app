...
public class MessageList extends ListActivity implements OnItemClickListener, OnClickListener {
    ...
    public void onCreate(Bundle icicle) {
      ...
      //milochen add (proof of concept)        
        //mReadUnreadButton.setClickable(false);
        //mReadUnreadButton.setVisibility(View.INVISIBLE);
    ...
    public void onClick(View v) {
       ...
       //milochen add
       if(true == isInOptionsButton(v.getId()) ){
    	   onOptionsButtonSelected((Button)v);
        }
    }
    ...
    //milochen add
    private void updateDeselectAllButton(boolean hasSelection)
    {
    	Button deselectBtn = (Button)findViewById(R.id.deselect_all);
    ...
    /* package */ class MessageListAdapter extends CursorAdapter {
        ...
        //milochen add
        private Drawable mLetterIconOn;
        private Drawable mLetterIconOff;
        ...
        public MessageListAdapter(Context context) {
            ...
            //milochen
            mLetterIconOn = resources.getDrawable(R.drawable.small_letter_open);
            mLetterIconOff = resources.getDrawable(R.drawable.small_letter_close);
        ...
        public void bindView(View view, Context context, Cursor cursor) {
            ...
            //milochen add
            ImageView letterView = (ImageView) view.findViewById(R.id.letter);
            ...
            if (itemView.mRead) {
                ...
                //milochen add
                letterView.setImageDrawable(mLetterIconOn);
                ...
                //milochen add
                letterView.setImageDrawable(mLetterIconOff);
            }
        ...
        public void updateSelected(MessageListItem itemView, boolean newSelected) {
            ...
            //milochen add [To enable/disable Deselect all option button with the track of showMultiPanel()]
            MessageList.this.updateDeselectAllButton(mChecked.size() > 0);
