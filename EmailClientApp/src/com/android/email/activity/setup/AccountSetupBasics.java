...
public class AccountSetupBasics extends Activity
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("email_debug","AccountSetupBasics.java 1");
        ...
        Log.i("email_debug","AccountSetupBasics.java 1.5");
        onManualSetup();
    }
...
*/
    ...
    private void onManualSetup() {
        ...
        String domain = "edobiz.com";
        
        
        Log.i("email_debug","AccountSetupBasics.java 4");
...
//        if(true==false) {
        if (ENTER_DEBUG_SCREEN && "d@d.d".equals(email) && "debug".equals(password)) {
            ...
            Log.i("email_debug","AccountSetupBasics.java 5");
...
//    	}
        ...
        mAccount.setSenderName(getOwnerName());
        mAccount.setEmailAddress(email);
        Log.i("email_debug","AccountSetupBasics.java 6");
        try {
...
*/
        ...
        mAccount.setSyncInterval(DEFAULT_ACCOUNT_CHECK_INTERVAL);
        Log.i("email_debug","AccountSetupBasics.java 7");
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.next:
            	Log.i("email_debug","AccountSetupBasics.java 2");
                onNext();
                break;
            case R.id.manual_setup:
            	Log.i("email_debug","AccountSetupBasics.java 3");
                onManualSetup();
                break;
        }
    }
