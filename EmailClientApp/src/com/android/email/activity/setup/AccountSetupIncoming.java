...
public class AccountSetupIncoming extends Activity implements OnClickListener {
	...
	//milochen add 
	private boolean mIsCleanStorageDataFromUI = false; //When isCleanStorageDataFromUI==true is needed when build new account
    ...
    //milochen add
    public static void actionIncomingSettings_NewCase(Activity fromActivity, EmailContent.Account account,
            boolean makeDefault) {    	
        Intent i = new Intent(fromActivity, AccountSetupIncoming.class);
        i.putExtra(EXTRA_ACCOUNT, account);
        i.putExtra(EXTRA_MAKE_DEFAULT, makeDefault);
        i.putExtra("NEW_CASE", true);
        fromActivity.startActivity(i);    	
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //milochen add
        mIsCleanStorageDataFromUI = getIntent().getBooleanExtra("NEW_CASE", false);
        /*
        ...
        try {
            ...
            //milochen add 
            //After pass the checking in SetupBasics, we need to clear data here.
            if(mIsCleanStorageDataFromUI==true){
            	username="";
            	password="";
            }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == RESULT_OK) {
            if (Intent.ACTION_EDIT.equals(getIntent().getAction())) {
                ...
                AccountSetupOutgoing.actionOutgoingSettings_NewCase(this, mAccount, mMakeDefault);
                finish();
            }
        }
    }
