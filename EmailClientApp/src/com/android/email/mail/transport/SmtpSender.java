...
public class SmtpSender extends Sender {
    ...
    private SmtpSender(Context context, String uriString) throws MessagingException {
    	Log.i("EMAIL", "SmtpSender(uriString=" +uriString+ ") enter");
        mContext = context;
        URI uri;
        try {
    ...
    public void sendMessage(long messageId) throws MessagingException {
    	Log.i("EMAIL", "SmtpSender.sendMessage() enter");
        close();
        open();
        ...
        Log.i("EMAIL", "from = " + from);
        Log.i("EMAIL", "to = " + to);
        Log.i("EMAIL", "cc = " + cc);
        Log.i("EMAIL", "bcc = " + bcc);
        Log.i("EMAIL", "from.getAddress() = " + from.getAddress());
        for (Address address : to) {
        	Log.i("EMAIL", "to[].getAddress() = " + address.getAddress());
        }
        for (Address address : cc) {        
        Log.i("EMAIL", "cc[].getAddress() = " + address.getAddress());
        }
        for (Address address : bcc) {
        Log.i("EMAIL", "bcc[].getAddress() = " + address.getAddress());
        }
        ...
        Log.i("EMAIL", "SmtpSender.sendMessage() leave");
    }
